...
from pulumi_kubernetes.core.v1 import ContainerArgs, PodSpecArgs, PodTemplateSpecArgs, Service, ServicePortArgs, ServiceSpecArgs, Namespace
from pulumi_kubernetes.meta.v1 import LabelSelectorArgs, ObjectMetaArgs
from pulumi_random import RandomPassword

# TODO: use config for custom machine type
...
NODE_MACHINE_TYPE = config.get('node_machine_type') or default_machine_type
...
# Create namespaces
devops_tools_ns = Namespace(
    "devops-tools",
    metadata={
        "name": "devops-tools",
    }, opts=ResourceOptions(provider=k8s_provider))

monitoring_observability = Namespace(
